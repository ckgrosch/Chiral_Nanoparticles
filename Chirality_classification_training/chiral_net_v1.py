...
X = h5py.File('/global/scratch/cgroschner/chiral_data/chiral_image_stack.h5','r')['stack'][:,:,:]
Y = h5py.File('/global/scratch/cgroschner/chiral_data/chiral_mask_stack.h5','r')['masks'][:,:,:]
...
save_weights = '/global/scratch/cgroschner/chiral_net_v1.h5'
save_predictions = '/global/scratch/cgroschner/chiral_net_v1.npy'
...
print(model.summary())
model.fit_generator(train_generator,steps_per_epoch=2000,epochs=10,callbacks = callbacks_list,validation_data=test_generator,validation_steps=500,verbose = 2)
predY = model.predict(trainX[2000:2500],steps=2,verbose=1)

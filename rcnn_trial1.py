...
save_weights = '/global/scratch/cgroschner/chiral_nanoparticles/rcnnV1_chirality_classification_00pwrongleftrightlabels_weights_20200821.h5'
save_history = '/global/scratch/cgroschner/chiral_nanoparticles/rcnnV1_chirality_classification_00pwrongleftrightlabels_history_20200821.h5'
...
def sub_final_stack(input_,previous_pred):
    ...
    drop = Dropout(0.5)(act1)
    dense2 = Dense(2)(drop)
    concat = concatenate([dense2,previous_pred],axis = 3)
...
def complete_model(input_shape):
    ...
    model = Model(inputs=inputs, outputs=final3)
    return model
